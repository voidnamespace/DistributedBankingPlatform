...
namespace AuthService.Application.Tests.Features.Users.GetAllUsers;
...
public class GetAllUsersHandlerTests
{
    ...
    public async Task Handle_WithUsersFromRepository_ShouldReturnMappedUserDtos()
    {
        ...
        result[0].Should().BeEquivalentTo(new UserResult
        {
            UserId = firstUser.Id,
        ...
        result[1].Should().BeEquivalentTo(new UserResult
        {
